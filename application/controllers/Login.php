...
class Login extends CI_Controller
{
    ...
    // Add the validation messages to login page form
    public function validate_login($from = "")
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('error_message', get_phrase('check the highlighted with error message inputs'));
            $this->session->set_flashdata('form_errors', $errors);
            redirect(site_url('login'), 'refresh');
        } else {
            // Perform the actual login check if validation passes
    ...
    public function logout($from = "")
    {
        ...
        // ! destroy all session data to avoid session overlap with other users
