...
class Zoom
{
    ...
    {
        // Get Zoom Settings
        $zoom_settings = get_settings('zoom_settings', true);

        // Define Zoom Credentials
        $this->client_id = $zoom_settings['client_id'];
        $this->client_secret = $zoom_settings['client_secret'];
