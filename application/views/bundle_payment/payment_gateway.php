		...
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-12">
					...
					<a href="<?= site_url('bundle_details/'.$bundle_details['id'].'/'.slugify($bundle_details['title'])); ?>" class="close-btn-light float-end"><i class="fa fa-times"></i></a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-md-1"></div>
				...
				<div class="col-md-8">
					<div class="w-100">
						...
						<p class="float-start mt-4"><?= site_phrase('included_courses'); ?></p>
						<?php $counter = 0; $course_actual_price = 0; ?>
						<?php foreach ($bundle_courses as $course_details) :
							$counter++; ?>

							<p class="item float-start m-0">
								<span>-</span>
					...
					<div class="w-100 float-start mt-4 indicated-price">
						<div class="float-end total-price"><small class="text-muted"><strike><?php echo currency($course_actual_price); ?></strike></small> | <?php echo currency($bundle_details['price']); ?></div>
