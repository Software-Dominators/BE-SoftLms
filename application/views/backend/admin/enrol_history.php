        ...
        <div class="card">
            ...
            <h4  
                class=" header-style page-title"> <i style=" color: #232F43;font-size: 27px; margin-inline-end:16px;" class="dripicons-view-apps"></i>
                 <?php echo get_phrase('Enrolment'); ?>  
                 <i class="fa-solid fa-angle-right"></i>
                 <span>    <?php echo get_phrase('enrollment_history'); ?>  </span>
...
<div class="row enrol-history">
    <div class="col-xl-12">
        <div class="card" style='height:100vh'>
            <div class="card-body">
              <h4 class=" header-title"><?php echo get_phrase('enrol_histories'); ?></h4>
              <div class="row justify-content-md-center ">
                  <div class="col-xl-10">
                      <form class=" " action="<?php echo site_url('admin/enrol_history/filter_by_date_range') ?>" method="get">
                          <div class="col-xl-12 d-flex align-items-center justify-content-center enrol-history-action">
                              <div class="">
                              ...
                              <div class="col-xl-2">
                              <button type="submit" class="submit-btn" id="submit-button" onclick="update_date_range();"> <?php echo get_phrase('filter');?></button>
                          </div>
                          </div>
                              ...
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  <tr class="gradeU">
                                      ...
                                      <td>
                                          ...
                                          <small class="user-email"><?php echo get_phrase('email').': '.$user_data['email']; ?></small>
                                      </td>
                                      <td><strong class="badge badge-secondary"><a href="<?php echo site_url('admin/course_form/course_edit/'.$course_data['id']); ?>" target="_blank"><?php echo $course_data['title']; ?></a></strong></td>
