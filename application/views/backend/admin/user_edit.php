            ...
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/users/edit/'.$user_id); ?>" enctype="multipart/form-data" method="post">
                    <div id="progressbarwizard">
                        <ul class="nav nav-pills nav-justified form-wizard-header mb-3 stepper">
                            <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group  mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" value="<?php echo $user_data['another_phone']; ?>" id="another_phone" name="another_phone">
                                            </div>
                                        </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-10">
                                        ...
                                        <div class="icon">
                                            ...
                                            <h4 class=""><?php echo get_phrase('The student is ready to edit'); ?> !</h4>
