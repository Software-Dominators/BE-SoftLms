        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php echo get_phrase('Reports'); ?> 
                 ...
                 <span>  <?php echo get_phrase('admin_revenue'); ?> </span>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xl-12  ">
                        <form class="form-inline align-items-start" action="<?php echo site_url('admin/admin_revenue/filter_by_date_range') ?>" method="get">
                            <div class="col-xl-10">
                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            <?php foreach ($payment_history as $payment) :
                                ...
                                <tr class="gradeU">
                                    <td class="">
                                        <strong class="badge badge-secondary"><a href="<?php echo site_url('admin/course_form/course_edit/' . $course_data['id']); ?>" target="_blank"><?php echo $course_data['title']; ?></a></strong>
