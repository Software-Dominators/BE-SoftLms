        ...
        <?php foreach ($purchase_history->result_array() as $purchase):
            ...
            <tr class="gradeU">
              <td>
                  ...
                  <small class="user-email"><?php echo $user_data['email']; ?></small>
              </td>
              <td ><a class="badge badge-secondary" href="<?php echo site_url('home/course/' . rawurlencode(slugify($course_data['title'])) . '/' . $course_data['id']); ?>" target="_blank"><?php echo $course_data['title']; ?></a></td>
              <td>
