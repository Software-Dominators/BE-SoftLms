...
<div class="card">
    <div class="card-body">
        <div class="row">
            <dclass="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                ...
                <ul class="message__user-list">
                    ...
                    foreach ($message_threads as $row):
                        ...
                        ?>
                        <li class="message__user-list-item">
                ...
                <!-- <ul class="navbar-nav">
                    ...
                    foreach ($message_threads as $row):
                        ...
                        ?>
                        <li class="nav-item">
                            <a class="text-left mb-1 btn btn-light d-block <?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code'])
                                echo 'active'; ?>"
