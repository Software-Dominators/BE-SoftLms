        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php echo get_phrase('admin'); ?>
                 ...
                 <!-- <a href="<?php echo site_url('admin/admins'); ?>" class="btn-outline-primary alignToTitle"> <i class="mdi mdi-arrow-left"></i> <?php echo get_phrase('back_to_admins'); ?></a> -->
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/admins/add'); ?>" enctype="multipart/form-data" method="post">
                    <div id="progressbarwizard">
                        <ul class="nav nav-pills nav-justified form-wizard-header stepper mb-3 stipper">
                            <li class="nav-item">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-10">
                                        ...
                                        <div class="icon">
                                            ...
                                            <h4 class=""><?php echo get_phrase('The admin is ready to add'); ?> !</h4>
