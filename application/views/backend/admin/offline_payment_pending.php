                            ...
                            <td>
                              <div class="dropright dropright">
                                  ...
                                  <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" onclick="show_loader_modal()" href="<?php echo site_url('addons/offline_payment/pending/approve/'.$offline_payment['id'].'/'.$offline_payment['user_id'].'/'.$offline_payment['amount']); ?>"><i></i><?php echo get_phrase('approve'); ?></a></li>

                                        <li><a class="dropdown-item" href="<?php echo site_url('addons/offline_payment/pending/suspended/'.$offline_payment['id'].'/'.$offline_payment['user_id']) ?>"><?php echo get_phrase('suspended'); ?></a></li>

                                      <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/offline_payment/pending/delete/'.$offline_payment['id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                  </ul>
                              </div>
                            </td>
                        </tr>
