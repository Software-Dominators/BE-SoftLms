			...
			<div class="card-body">
				...
				foreach($edit_data as $row):
					...
					<div class="row justify-content-end w-100 ">
						<button type="submit" class="submit-btn"><?php echo get_phrase('update_profile');?></button>
					</div>
				</form>
				<?php
			endforeach;
	...
	<div class="card">
		<div class="card-body">
			<?php foreach($edit_data as $row): ?>
				...
				<div class="row justify-content-end w-100">
					<button type="submit" class="submit-btn"><?php echo get_phrase('update_password');?></button>
				</div>
			</form>
		<?php endforeach; ?>
	</div>
