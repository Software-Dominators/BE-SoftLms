        ...
        <div class="col-md-12">
            <div class="form-group">
                <select class="select2" id="course_id_for_lesson" name="course_id_for_lesson">
                    ...
                    <?php foreach($this->crud_model->get_course_by_user($this->session->userdata('user_id'), 'general')->result_array() as $course): ?>
...
<div class="mt-3">
    ...
    <?php if (addon_status('amazon-s3')): ?>
        <div class="custom-control custom-radio">
            ...
            <label class="custom-control-label" for="amazon-s3"><?php echo get_phrase('Amazon S3 Bucket'); ?></label>
        </div>
    <?php endif;?>
