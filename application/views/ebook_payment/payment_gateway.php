    ...
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-12">
                    <span
                        class="payment-header-text float-start"><b><?php echo get_phrase('make_payment'); ?></b></span>
                    <a href="<?php echo site_url('ebook/ebook_details/'.slugify($ebook_details['title']).'/'.$ebook_details['ebook_id']); ?>"
                        class="close-btn-light float-end"><i class="fa fa-times"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="row payment-gateway paypal" onclick="selectedPaymentGateway('paypal')">
                        <div class="col-12">
                            ...
                            <img class="payment-gateway-icon"
                                src="<?php echo base_url('assets/payment/paypal.png'); ?>">
                        </div>
                    </div>
                    <?php endif;
                    ...
                    <div class="row payment-gateway stripe" onclick="selectedPaymentGateway('stripe')">
                        <div class="col-12">
                            ...
                            <img class="payment-gateway-icon"
                                src="<?php echo base_url('assets/payment/stripe.png'); ?>">
                        </div>
                    </div>
                    <?php endif;
                    ...
                    <div class="row payment-gateway razorpay" onclick="selectedPaymentGateway('razorpay')">
                        <div class="col-12 py-3px">
                            <img class="tick-icon razorpay-icon"
                                src="<?php echo base_url('assets/payment/tick.png'); ?>">
                            <img class="payment-gateway-icon"
                                src="<?php echo base_url('assets/payment/razorpay.png'); ?>">
                        </div>
                    </div>
                    <?php endif;?>
                ...
                <div class="col-md-8">
                    <div class="w-100 d-grid">
                        <p class="pb-2 payment-header"><?php echo get_phrase('order'); ?>
                            <?php echo get_phrase('summary'); ?></p>

                        <p class="item float-start">
                            <span class="count-item"><?php echo 1; ?></span>
                            <span class="item-title"><?php echo $ebook_details['title']; ?>
                                <span class="item-price">
                                    <?php $total = 0; ?>
                                    <?php if ($ebook_details['discount_flag'] == 1) :
                                        $total = $ebook_details['discounted_price'];
										echo currency($total);
										else :
                                            $total = $ebook_details['price'];
											echo currency($total);
										endif; ?>
                                </span>
                            </span>
                    ...
                    <div class="w-100 float-start mt-4 indicated-price">
                        <div class="float-end total-price"><?php echo currency($total); ?></div>
                        <div class="float-end total"><?php echo get_phrase('total'); ?></div>
                    </div>
                    <div class="w-100 float-start">
                        <form action="<?php echo site_url('addons/ebook/paypal_checkout/'.$ebook_id); ?>" method="post"
                            class="paypal-form form">
                            <hr class="border mb-4">
                            <input type="hidden" name="total_price_of_checking_out" value="<?php echo $price ?>">
                            <button type="submit"
                                class="payment-button float-end"><?php echo get_phrase('pay_by_paypal'); ?></button>
                        </form>
                        ...
                        <form action="<?php echo site_url('addons/ebook/razorpay_checkout/'.$ebook_id); ?>" method="post"
                            class="razorpay-form form">
                            <hr class="border mb-4">
                            <input type="hidden" name="total_price_of_checking_out"
                                value="<?php echo $total_price_of_checking_out; ?>">
                            <button type="submit"
                                class="payment-button float-end"><?php echo get_phrase('pay_by_razorpay'); ?></button>
                        </form>
