        ...
        <div class="row">
            ...
            <?php foreach ($blogs->result_array() as $blog): ?>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blogs__content d-flex flex-column h-100">
                        ...
                        <div class="blogs__bottom mt-auto   d-flex  justify-content-between flex-md-row flex-column">
                            <div class="blogs__creator d-flex align-items-center ">
                                ...
                                <h5 class="ms-2"><?php echo $user_details['first_name'] . ' ' . $user_details['last_name']; ?></h5>
                            </div>
                            <div class="blogs__read-more text-end">
                                <a class="text-end"
