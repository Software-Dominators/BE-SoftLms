              ...
              <div class="menu_pro_wish-flex">
                ...
                <div class="text w-100">
                  ...
                  <div class="spandiv">
                    ...
                    <?php if(!$course_details['is_free_course']): ?>
                        <?php $course_in_cart = cart_items_get_index('course', $course_details['id']) != null; ?>
                        <span onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id'].'/from_wishlist'); ?>');" id="add_course_to_cart_btn_from_wishlist<?php echo $course_details['id']; ?>" class="checkPropagation float-end me-4 <?php if($course_in_cart) echo 'd-hidden'; ?>" data-bs-toggle="tooltip" title="<?php echo get_phrase('Add to cart'); ?>"><i class="fas fa-cart-plus text-13px p-1"></i></span>

                        <span onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id'].'/from_wishlist'); ?>');" id="added_course_to_cart_btn_from_wishlist<?php echo $course_details['id']; ?>" class="checkPropagation float-end me-4 <?php if(!$course_in_cart) echo 'd-hidden'; ?>" data-bs-toggle="tooltip" title="<?php echo get_phrase('Remove from cart'); ?>"><i class="fas fa-minus-circle text-13px p-1"></i></span>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
