    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <?php if(addon_status('course_bundle')): ?>
        <?php $header_menu_counter += 1; ?>
          ...
          <li class="nav-item">
          <a class="nav-link" href="<?php echo site_url('home/courses'); ?>"><span> <?php echo get_phrase("FAQ's"); ?></span> </a>
        </li>
...
<div class="wisth_tgl_div">
  <div class="wisth_tgl_2div">
    ...
    <a class="menu_pro_cart_tgl mt-1 icon"
      >  <img loading="lazy" src="assets/frontend/design-one/assets/images/home/cart.svg" alt="Logo" />
                  ...
                  <select onchange="actionTo(<?php echo site_url('home/switch_language/') ?>${$(this).val()})" class="select-control form-select nice-select">
                    ...
                    foreach ($languages as $language): ?>
                      <?php if (trim($language) != ""): ?>
                        ...
                        <option class="p-3 " value="<?php echo strtolower($language); ?>" <?php if ($selected_language == $language): ?>selected<?php endif; ?>><?php echo ucwords($language);?></option>
                      <?php endif; ?>
                    <?php endforeach; ?>
