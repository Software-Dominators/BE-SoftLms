...
<div class="search">
        <div class="search-bar">
            <form action="<?php echo site_url('blogs'); ?>" method="get">
                <button type="submit" class="search-btn"><i style =" max-width: 14px !important;min-height: 14px !important; margin-top:3px; color:#A1A1A1;" class="fa-solid fa-magnifying-glass"></i></button>
                <input value="<?php if(isset($search_string) && !empty($search_string)) echo $search_string; ?>" type="text" name="search" class="form-control blog-search" placeholder="<?php echo site_phrase('Type your keywords'); ?>" id="search-place">
    ...
    <div class="categories mb-4">
        <ul>
            <?php foreach($popular_categories as $popular_category): ?>
                ...
                <li class="d-flex align-items-center">
                    <a class="cateogry-number" href="<?php echo site_url('blogs?category='.$blog_category['slug']); ?>" class="me-1"><?php echo $blog_category['title']; ?></a>
        ...
        <a class=" cateogry-number text-14px mx-0 mt-4 text-muted" href="<?php echo site_url('blog/categories'); ?>"><?php echo site_phrase('all_categories'); ?></a>
    </div>
    <div class="title">
        ...
        <div class="post">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-12">
                   <a href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>"><h5  class="blog-title"><?php echo $latest_blog['title']; ?></h5></a>
                   <p class="cateogry-number"><i class="fa-solid fa-calendar-days"></i> <?php echo date('D, d M Y', $latest_blog['added_date']) ?></p>
                </div>
