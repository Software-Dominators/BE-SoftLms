                    ...
                    <div class="col-6">
                        <div class="course-instructor__content d-flex ">
                            ...
                            <div class=" d-flex flex-column w-100">
                                <div class="course-instructor__text">
                                        ...
                                        <a href="<?php echo $social_link; ?>">
                                            ...
                                            <?php elseif ($key == 'linkedin'): ?>
                                                <i class="fa-brands fa-linkedin" data-bs-toggle="tooltip"
                                                    title="<?php echo get_phrase('Linkedin'); ?>"></i></a>
                                        <?php endif; ?>
                                        </a>
                                    <?php endforeach; ?>
                                </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-8">
                    <div class="instructor-text">
                        <h2 class="text-black ms-0 fw-600">
                        ...
                        <div class="ellipsis-line-2 font-inter-light">
                            <?php echo ($instructor['biography']) ? strip_tags($instructor['biography']) : ''; ?>
                        </div>
                    </div>
                    <div class="instructor-icon mt-3">
                        ...
                        <?php endforeach; ?>
                        <a class="btn btn-primary py-2 btn-sm"
                            href="<?php echo site_url('home/instructor_page/' . $instructor_id) ?>"
                            target="_blank"><?php echo get_phrase('View Profile'); ?></a>
                    </div>
                </div>
