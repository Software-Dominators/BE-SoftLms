    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <h1><?php echo get_phrase('Login Confirmation'); ?><span>!</span></h1>
                <p>
                    <?php echo site_phrase('let_us_know_that_this_email_address_belongs_to_you'); ?>
                    <?php echo site_phrase('Enter_the_code_from_the_email_sent_to').
                     ' <b>'.$this->session->userdata('new_device_user_email'); ?>
                    
                </p>
              
                <!-- <p><?php echo site_phrase('let_us_know_that_this_email_address_belongs_to_you'); ?>
                     <?php echo site_phrase('Enter_the_code_from_the_email_sent_to').
                     ' <b>'.$this->session->userdata('new_device_user_email'); ?></p> -->
