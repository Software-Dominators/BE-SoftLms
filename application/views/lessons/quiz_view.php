    ...
    <div class="card-header ps-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 fw-bold text-md-end">
                <span
                    class="text-muted"><?php echo get_phrase('total_questions') . ': ' . $quiz_questions->num_rows(); ?></span>
                <span class="text-muted">|</span>
                <span
                    class="text-muted"><?php echo get_phrase('total_marks') . ': ' . json_decode($lesson_details['attachment'], true)['total_marks']; ?></span>
            </div>
        </div>
    </div>
                ...
                <?php if ($is_course_instructor == 1): ?>
                    <div class="col-md-6 mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <small
                                class="text-muted"><?php echo site_phrase('select_a_student_to_view_the_answer_sheet'); ?></small>
                        </div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <?php if ($timer > 0): ?>
                        <div class="col-12 text-center pt-3">
                            ...
                            <?php else: ?>
                                <button class="btn btn-primary" id="quiz-start-brn"
                                    onclick="startQuiz(this)"><?php echo get_phrase('start_quiz'); ?></button>
                            <?php endif; ?>
                        </div>
