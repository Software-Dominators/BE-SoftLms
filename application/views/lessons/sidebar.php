      ...
      <?php foreach ($sections as $key => $section): ?>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header " id="section<?php echo $section['id']; ?>">
            <button class="accordion-button  <?php if ($lesson_details['section_id'] != $section['id'])
          ...
          <div id="collapseOne<?php echo $section['id'] ?>" class="accordion-collapse collapse <?php if ($lesson_details['section_id'] == $section['id'])
               echo 'show'; ?>" aria-labelledby="section<?php echo $section['id']; ?>"
            ...
            <div class="accordion-body position-relative">
              ...
              <ul class="course-content-items" style="<?php if ($is_restricted)
                echo 'filter: blur(1px);' ?>">
              ...
              foreach ($lessons as $key => $lesson):
                ...
                ?>
                  ...
                  <li class="item <?php if ($lesson['id'] == $lesson_details['id'])
                    echo 'sidebar-lesson__active-lesson-bg'; ?>">
